...
public class SimpleCamera3Activity extends Activity {

    public static SimpleCamera3Activity activity = null;
...
PreyLogger.i("IMG SimpleCamera2Activity onCreate");
    ...
    private final CameraDevice.StateCallback mStateCallback = new CameraDevice.StateCallback() {
        ...
        public void onError(@NonNull CameraDevice cameraDevice, int error) {
            PreyLogger.i("CAMERA onError"+error);
            mCameraOpenCloseLock.release();
            cameraDevice.close();
            mCameraDevice = null;
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            PreyLogger.i("CAMERA mCameraId:"+ mCameraDevice);
